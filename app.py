...
@app.route('/tags')
# function displays a page with info on all tags
def tags_index():
    tags = Tag.query.all()
    return render_template('tags/index.html', tags=tags)

@app.route('/tags/new')
# function displays a form to add a new tag
def tags_new_form():
...
# function displays info on a specific tag
def tags_show(tag_id):
    tag = Tag.query.get_or_404(tag_id)
    return render_template('tags/show.html', tag=tag)

@app.route('/tags/<int:tag_id>/edit')
# function displays a form to edit an existing tag
...
# function edits an existing tag
...
# function deletes an existing tag
